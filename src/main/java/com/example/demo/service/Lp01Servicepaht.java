...
public class Lp01Servicepaht {
	...
	public List<employeedetail> searchEmp(String keyword){
	    ...
	    List<employeedetail> a = corePrimaryRepository.getDataList(sql.toString(),params,employeedetail.class);
		return a;

	}

	public Response save(Lp02employeedetailModel model){
		StringBuilder sql = new StringBuilder();
		SqlParams params = SqlParams.create();
		...
		sql.append(" INSERT INTO  employee  ( emp_code , emp_name  ,  emp_last_name  ,  emp_phone  ,  emp_job_title )  VALUES (:emp_code,:emp_name,:emp_last_name,:emp_phone,:emp_job_title);  ");
	...
	public Lp02employeedetailModel sesearchDetail(Lp02employeedetailModel model){
		Lp02employeedetailModel a = new Lp02employeedetailModel();
		SqlParams params = SqlParams.create();
		StringBuilder sql = new StringBuilder();
		...
		a = corePrimaryRepository.getData(sql.toString(),params,Lp02employeedetailModel.class);
		return a;
	}

	public Response edit(Lp02employeedetailModel model){
		StringBuilder sql = new StringBuilder();
		SqlParams params = SqlParams.create();
		params.add("emp_code", model.getEmp_Code());
		params.add("emp_name", model.getEmp_Name());
		...
		sql.append("UPDATE  employee SET emp_name=:emp_name,  emp_last_name=:emp_last_name,  emp_phone=:emp_phone,  emp_job_title =:emp_job_title ");
	...
	public Response delete(Lp02employeedetailModel model){
